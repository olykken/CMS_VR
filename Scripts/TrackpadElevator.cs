...
//            //var movement = playerPresence.GetHeadset().up * movementSpeed * Time.deltaTime;
//            float fixX = transform.position.x;
//            float fixZ = transform.position.z;
//            transform.position += (movement);
//            transform.position = new Vector3(fixX, transform.position.y, fixZ);
//        }
